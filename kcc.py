...
st.sidebar.text(' - 관계사간 전출입지급여 등 지급규칙')
st.sidebar.text(' - 하자및폐기발생에 대한 사후조치')
...
if "messages" not in st.session_state:
    ...
    st.success(" ex) 휴대전화 지원 대상하고 금액 알려줘. (구체적이고 명확하게 30자 이내로 질문해주세요.)", icon="✔️")
